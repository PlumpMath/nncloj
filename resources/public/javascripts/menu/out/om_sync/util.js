...
if((n__$1 > 0))
{{
var G__10506 = (n__$1 - 1);
var G__10507 = cljs.core.pop.call(null,res);
n__$1 = G__10506;
res = G__10507;
continue;
}
...
om_sync.util.tx_tag = (function tx_tag(p__10508){var map__10510 = p__10508;var map__10510__$1 = ((cljs.core.seq_QMARK_.call(null,map__10510))?cljs.core.apply.call(null,cljs.core.hash_map,map__10510):map__10510);var tx_data = map__10510__$1;var tag = cljs.core.get.call(null,map__10510__$1,new cljs.core.Keyword(null,"tag","tag",1014018828));if((tag instanceof cljs.core.Keyword))
{return tag;
} else
