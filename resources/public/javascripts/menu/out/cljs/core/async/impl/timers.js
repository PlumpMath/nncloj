...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13286 = 0;while(true){
if((i_13286 < arr.length))
{(arr[i_13286] = null);
{
var G__13287 = (i_13286 + 1);
i_13286 = G__13287;
continue;
}
} else
...
{var i_13293 = (self__.level + 1);while(true){
if((i_13293 <= (new_level + 1)))
{(update[i_13293] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13295 = 0;while(true){
if((i_13295 <= self__.level))
{var links_13296 = (update[i_13295]).forward;if(((links_13296[i_13295]) === x__$1))
{(links_13296[i_13295] = (x__$1.forward[i_13295]));
{
var G__13297 = (i_13295 + 1);
i_13295 = G__13297;
continue;
}
} else
{{
var G__13298 = (i_13295 + 1);
i_13295 = G__13298;
continue;
}
}
