...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13321 = 0;while(true){
var m_13322 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13322 == null))
{} else
{m_13322.call(null);
if((count_13321 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13323 = (count_13321 + 1);
count_13321 = G__13323;
continue;
}
} else
{}
