...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_14951 = 0;while(true){
if((i_14951 < arr.length))
{(arr[i_14951] = null);
{
...
{var i_14958 = (self__.level + 1);while(true){
if((i_14958 <= (new_level + 1)))
{(update[i_14958] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14960 = 0;while(true){
if((i_14960 <= self__.level))
{var links_14961 = (update[i_14960]).forward;if(((links_14961[i_14960]) === x__$1))
{(links_14961[i_14960] = (x__$1.forward[i_14960]));
{
var G__14962 = (i_14960 + 1);
i_14960 = G__14962;
continue;
}
} else
