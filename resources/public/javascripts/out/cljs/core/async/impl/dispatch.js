...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14986 = 0;while(true){
var m_14987 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14987 == null))
{} else
{m_14987.call(null);
if((count_14986 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14988 = (count_14986 + 1);
count_14986 = G__14988;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3431__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3431__auto__)
