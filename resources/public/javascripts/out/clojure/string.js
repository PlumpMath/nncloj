...
{{
var G__15066 = cljs.core.pop.call(null,v__$1);
v__$1 = G__15066;
continue;
}
} else
...
{var pred__15070 = cljs.core._EQ_;var expr__15071 = limit;if(cljs.core.truth_(pred__15070.call(null,1,expr__15071)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__15070.call(null,2,expr__15071)))
...
var G__15073 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__15074 = (limit__$1 - 1);
var G__15075 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__15073;
limit__$1 = G__15074;
parts = G__15075;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___15077 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___15077))
{var replacement_15078 = temp__4090__auto___15077;buffer.append([cljs.core.str(replacement_15078)].join(''));
} else
{buffer.append(ch);
}
{
var G__15079 = (index + 1);
index = G__15079;
continue;
}
}
