...
if((n__$1 > 0))
{{
var G__12171 = (n__$1 - 1);
var G__12172 = cljs.core.pop.call(null,res);
n__$1 = G__12171;
res = G__12172;
continue;
}
...
om_sync.util.tx_tag = (function tx_tag(p__12173){var map__12175 = p__12173;var map__12175__$1 = ((cljs.core.seq_QMARK_.call(null,map__12175))?cljs.core.apply.call(null,cljs.core.hash_map,map__12175):map__12175);var tx_data = map__12175__$1;var tag = cljs.core.get.call(null,map__12175__$1,new cljs.core.Keyword(null,"tag","tag",1014018828));if((tag instanceof cljs.core.Keyword))
{return tag;
} else
...
om_sync.util.edn_xhr = (function edn_xhr(p__12176){var map__12178 = p__12176;var map__12178__$1 = ((cljs.core.seq_QMARK_.call(null,map__12178))?cljs.core.apply.call(null,cljs.core.hash_map,map__12178):map__12178);var on_error = cljs.core.get.call(null,map__12178__$1,new cljs.core.Keyword(null,"on-error","on-error",1418576908));var on_complete = cljs.core.get.call(null,map__12178__$1,new cljs.core.Keyword(null,"on-complete","on-complete",2943599833));var data = cljs.core.get.call(null,map__12178__$1,new cljs.core.Keyword(null,"data","data",1016980252));var url = cljs.core.get.call(null,map__12178__$1,new cljs.core.Keyword(null,"url","url",1014020321));var method = cljs.core.get.call(null,map__12178__$1,new cljs.core.Keyword(null,"method","method",4231316563));var xhr = (new goog.net.XhrIo());goog.events.listen(xhr,goog.net.EventType.SUCCESS,(function (e){return on_complete.call(null,cljs.reader.read_string.call(null,xhr.getResponseText()));
}));
