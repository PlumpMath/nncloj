...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13337 = 0;while(true){
var m_13338 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13338 == null))
{} else
{m_13338.call(null);
if((count_13337 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13339 = (count_13337 + 1);
count_13337 = G__13339;
continue;
}
} else
{}
