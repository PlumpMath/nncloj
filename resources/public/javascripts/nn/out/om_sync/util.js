...
if((n__$1 > 0))
{{
var G__10522 = (n__$1 - 1);
var G__10523 = cljs.core.pop.call(null,res);
n__$1 = G__10522;
res = G__10523;
continue;
}
...
om_sync.util.tx_tag = (function tx_tag(p__10524){var map__10526 = p__10524;var map__10526__$1 = ((cljs.core.seq_QMARK_.call(null,map__10526))?cljs.core.apply.call(null,cljs.core.hash_map,map__10526):map__10526);var tx_data = map__10526__$1;var tag = cljs.core.get.call(null,map__10526__$1,new cljs.core.Keyword(null,"tag","tag",1014018828));if((tag instanceof cljs.core.Keyword))
{return tag;
} else
...
om_sync.util.edn_xhr = (function edn_xhr(p__10527){var map__10529 = p__10527;var map__10529__$1 = ((cljs.core.seq_QMARK_.call(null,map__10529))?cljs.core.apply.call(null,cljs.core.hash_map,map__10529):map__10529);var on_error = cljs.core.get.call(null,map__10529__$1,new cljs.core.Keyword(null,"on-error","on-error",1418576908));var on_complete = cljs.core.get.call(null,map__10529__$1,new cljs.core.Keyword(null,"on-complete","on-complete",2943599833));var data = cljs.core.get.call(null,map__10529__$1,new cljs.core.Keyword(null,"data","data",1016980252));var url = cljs.core.get.call(null,map__10529__$1,new cljs.core.Keyword(null,"url","url",1014020321));var method = cljs.core.get.call(null,map__10529__$1,new cljs.core.Keyword(null,"method","method",4231316563));var xhr = (new goog.net.XhrIo());goog.events.listen(xhr,goog.net.EventType.SUCCESS,(function (e){return on_complete.call(null,cljs.reader.read_string.call(null,xhr.getResponseText()));
}));
